...
[Full Changelog](https://github.com/cloudfoundry/stratos/compare/2.6.1...2.7.0)
...
- Fix timeout with long running service actions [\#4049] (https://github.com/cloudfoundry/stratos/pull/4049)
...
[Full Changelog](https://github.com/cloudfoundry/stratos/compare/2.5.3...2.6.0)
...
[Full Changelog](https://github.com/cloudfoundry/stratos/compare/2.5.2...2.5.3)

This release contains a number of fixes and improvements:

**Fixes:**

- Metrics only shown for most recently added k8s metrics endpoint [\#3861](https://github.com/cloudfoundry/stratos/issues/3861)
- Can't update user profile when using local user with mysql or postgres [\#3940](https://github.com/cloudfoundry/stratos/issues/3940)
...
- Backend update for cacheing compat for HTTP 1.0 clients [\#3931](https://github.com/cloudfoundry/stratos/pull/3931)

## 2.5.2

[Full Changelog](https://github.com/cloudfoundry/stratos/compare/2.5.1...2.5.2)
...
[Full Changelog](https://github.com/cloudfoundry/stratos/compare/2.5.0...2.5.1)
...
**Improvements:**
- Add ingress example and docs for kubernetes deloyment [\#2510](https://github.com/cloudfoundry/stratos/pull/2510)
